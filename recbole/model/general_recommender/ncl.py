...
class NCL(GeneralRecommender):
    ...
    def get_cl_loss(self, model_embed, llm_embed):
        cl_loss = 0.0
        llm_embed = llm_embed.T
        dots = torch.mm(model_embed, llm_embed)
        dots /= self.tau
    ...
    def forward(self):
        ...
        return user_all_embeddings, item_all_embeddings, embeddings_list, cl_loss
    ...
    def calculate_loss(self, interaction):
        ...
        user_all_embeddings, item_all_embeddings, embeddings_list, cl_loss = self.forward()
        ...
        # edit
        loss = mf_loss + self.reg_weight * reg_loss, ssl_loss, proto_loss
    ...
    def predict(self, interaction):
        ...
        user_all_embeddings, item_all_embeddings, embeddings_list, _ = self.forward()
