...
class ContextRecommender(AbstractRecommender):
    ...
    def embed_input_fields(self, interaction):
        ...
        """
        float_fields = []
        # print(self.float_field_names)
        # print(self.float_seq_field_names)
        # print(self.token_field_names) # NOTE: user_id, item_id are all token_field_names.
        # print(self.token_seq_field_names)
        # time.sleep(1000)
